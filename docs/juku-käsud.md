...
Failid paiknevad lintidel või ketastel, mille lugemisseadme tähis on tähestiku täht koos seda failinimest eraldava kooloniga (nt `A:`, `B:` või lindi puhul `T:`). Aktiivse lugemisseadme vahetamiseks tuleb käsklusena sisestada soovitud lugemisseadme tähis. Käskluse tulemusel muudetakse viibas osutatud aktiivset lugemisseadet `A>`, `B>`, `C>` jne.
